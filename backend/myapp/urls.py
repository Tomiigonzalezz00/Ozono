...
router.register(r'eventos-usuario', EventoUsuarioViewSet,
                basename='eventousuario')
...
urlpatterns = [
    ...
    path('api/password_reset/', PasswordResetRequestView.as_view(),
         name='password_reset_request'),
    path('api/password_reset/confirm/',
         PasswordResetConfirmView.as_view(), name='password_reset_confirm'),

    # --- ENDPOINTS DE PUNTOS VERDES FAVORITOS ---
    path('api/favorites/toggle/<str:punto_id>/',
    ...
    path('api/calendario-ambiental/', views.get_calendario_ambiental,
         name='get_calendario_ambiental'),

    # --- ENDPOINTS DE PUNTO VERDE ---
    # Ruta específica para la acción de votar
    path('api/puntos-verdes/<str:punto_id>/vote/',
